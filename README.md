...
**This project will no longer be updated or maintained as of August 2017.**
Please consider using its sister project
[getnews.tech](https://github.com/omgimanerd/getnews.tech), which uses
the [News API](https://newsapi.org) instead.
