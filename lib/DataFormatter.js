 ...
 * @type {string}
 */
DataFormatter.GITHUB_TEXT = 'Open source contributions welcome!\n'.green;
...
DataFormatter.format = function(data, options) {
   ...
   * We add two to account for the padding at either side of the section
   * column.
   */
   ...
   * take up (maxDisplayWidth - 3) - maxSectionsWidth characters. This ensures
   * that the formatted table will not exceed maxDisplayWidth characters in
   * width.
   */
